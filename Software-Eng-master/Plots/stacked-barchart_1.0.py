...
# Preparing data
trace1 = go.Bar(x=new_df['NOC'], y=new_df['Bronze'],
name='Bronze', marker={'color': '#CD7F32'})
trace2 = go.Bar(x=new_df['NOC'], y=new_df['Silver'],
...
# Preparing layout
layout = go.Layout(title='Medals earned by top 20 countries in the olympics', xaxis_title="NOC",
